          ...
          <br>
            ...
            <tr role="row" class="odd">
                                   ...
                                   <?php
                                    ...
                                    <tr>
                                      ...
                                      <th style="font-size: 8pt;">Rp. <?=$da['total']; ?></th>
                                      <th style="font-size: 8pt;">Rp. <?=$da['subtotal']; ?></th>
                                    </tr>
                                    <!-- stop if-->
                                    <?php } ?>
                                     <!-- stop perulangan $da -->
                                   ...
                                   <?php foreach($detail_proyek_ahs as $da) { 
                                    ...
                                    <th style="font-size: 8pt;">Rp.  <?= $jumlah ?></th>
                                    </tr>
                                    <?php break; } ?>
                                    <?php } ?>
            ...
            <?php } ?> 
             ...
             <thead>
               <tr role="row" class="odd">
                                    ...
                                    <th style="font-size: 8pt;">Rp. <?= $sum; ?></th>
            ...
            <thead>
               <tr role="row" class="odd">
                                    ...
                                    <th style="font-size: 8pt;">Rp. <?= $proyek['kontraktor']; ?></th>
            ...
            <thead>
               <tr role="row" class="odd">
                <?php $hasil = $sum + $kt; ?>
                                    ...
                                    <th style="font-size: 8pt;">Rp. <?= $hasil; ?></th>           
               </tr>
            </thead>
            </table>
