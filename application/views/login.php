...
<?php
          ...
          ?>
<body class="hold-transition login-page" style="background-image: url('<?php echo base_url('administrator/images/').$background->gambar ?>')">
<?php
                }
              ?>
<div class="login-box">
  ...
  <div class="login-box-body">
	<center>
    <img width="200px" src="<?php echo base_url('/images/pt_adm.jpg')?>"><br>
    <p></p>
  </center>    	 
