...
class Informasi_model extends CI_Model
{
   ...
   function __construct()
    ...
    function json() {
        $this->datatables->select('id_informasi,nama_informasi,gambar');
        $this->datatables->from('informasi');
        $this->datatables->add_column('action', anchor(site_url('informasi/update/$1'),'<button type="button" class="btn btn-warning"><i class="fa fa-pencil" aria-hidden="true"></i></button>'), 'id_informasi');
   ...
   function get_all()
	...
	$this->db->or_like('nama_informasi', $q);
